...
export const { useSemesterRegistrationMutation, useGetRegisteredSemesterQuery, useUpdateRegisteredSemesterMutation, useAddCourseMutation, useGetAllCoursesQuery, useAddFacultiesMutation } = courseManagementApi